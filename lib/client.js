		...
		function apply(ctx) {
			...
			ctx.slots.inject("conversation.chat.assistant-actions", () => ctx.slots.register({
				...
				return (0, react_jsx_runtime.jsx)("button", {
					type: "button",
					onClick: handleClick,
					onMouseEnter: (e) => { if (!copied) e.currentTarget.style.background = "var(--dsw-alias-interactive-bg-hover)"; },
					onMouseLeave: (e) => { e.currentTarget.style.background = "0 0"; },
					"aria-label": copied ? "已复制" : "复制会话引用",
					style: {
						width: "28px",
						height: "28px",
						color: copied ? "#3fb950" : "var(--dsw-alias-label-tertiary)",
						cursor: "pointer",
						background: "0 0",
						border: "none",
						borderRadius: "28px",
					...
					children: copied
						...
						: (0, react_jsx_runtime.jsxs)("svg", { width: 16, height: 16, viewBox: "0 0 16 16", fill: "none", children: [(0, react_jsx_runtime.jsx)("rect", { x: 5, y: 2, width: 8, height: 10, rx: 1.5, stroke: "currentColor", strokeWidth: 1.3 }), (0, react_jsx_runtime.jsx)("path", { d: "M3 5.5V12.5C3 13.3284 3.67157 14 4.5 14H10", stroke: "currentColor", strokeWidth: 1.3, strokeLinecap: "round" })] })
				});
			}));
