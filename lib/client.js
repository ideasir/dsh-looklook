	...
	factory: (require) => {
		...
		*/
		...
		function SwitchRow({ label, desc, checked, onChange }) {
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)(SliderSwitch, {
					checked,
					onChange,
					label
				})]
		...
		function LooklookFeaturesSection(props) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("hr", { style: css$1.divider }),
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						style: css$1.installRow,
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
							style: css$1.rowText,
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
								style: css$1.rowName,
		...
		*/
		...
		function UploadButton(props) {
			...
			const pick = async (file) => {
				...
				setNotice(null);
				try {
					if (!moreExtensions && !file.name.toLowerCase().endsWith(".zip")) throw new Error(t("upload.unsupported"));
					if (moreExtensions && !isUploadableName(file.name)) throw new Error(t("upload.unsupported"));
		...
		*/
		function apply(ctx) {
			...
			const useMoreExtensions = () => useFeaturesSnapshot((s) => s.status === "ready" && s.moreExtensions !== false);
