window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		/** Clean upload note rendered by the current client: 「[类型]name 排队中...」. */
				...
				(async () => {
					for (const file of files) {
						...
						try {
							...
							// Keep the UNIQUE saved name (image_xxx.png) so the
							// note is accurate and unambiguous — the model can
							// look it up directly, no fuzzy matching.
