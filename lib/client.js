window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		function createEyeController(api, sessionId) {
			...
			const refresh = async () => {
				...
				const vision = namespaceValueOf(response.result.value.namespaces, "vision");
		...
		function createFeatureController(api) {
			...
			const refresh = async () => {
				...
				const value = namespaceValueOf(response.result.value.namespaces, "looklook");
				store.set({
					status: "ready",
			...
			return {
				...
				setImageRecognition: (next) => {
					update({ imageRecognition: next });
				},
				setVideoRecognition: (next) => {
					update({ videoRecognition: next });
				}
			};
		}
		//#endregion
		...
		function createPendingFilesController() {
			...
			return {
				...
				update: (sessionId, index, patch) => {
					...
					const next = list.map((item, i) => i === index ? {
						...item,
						...patch
					} : item);
					store.set({
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
							style: css$2.hint,
							children: t("features.uploadHint")
						})
					]
				})
			});
		...
		function ProviderListEditor(props) {
			...
			(0, react.useEffect)(() => {
				(async () => {
					const response = await api.settings.describe({});
					if (response.result.ok) {
						const value = namespaceValueOf(response.result.value.namespaces, ns);
				...
				children: [
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							listModels !== void 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								style: {
									display: "flex",
									alignItems: "center",
									gap: 8
		...
		*/
		...
		function LocalAsrCard({ api, t }) {
			const [status, setStatus] = (0, react.useState)(null);
			const [busy, setBusy] = (0, react.useState)(false);
			const [error, setError] = (0, react.useState)(null);
			const refresh = async () => {
				try {
					const body = await (await fetch("/api/looklook-asr-status")).json();
					setStatus(body);
					setError(null);
				} catch (err) {
			...
			const install = async () => {
				...
				setError(null);
				try {
					const body = await (await fetch("/api/looklook-asr-install", { method: "POST" })).json();
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
								style: css$1.asrTitle,
								children: t("asr.local.title")
							}),
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
								style: css$1.asrDesc,
								children: status === null ? t("asr.local.checking") : installed ? t("asr.local.ready") : phaseLabel(status.phase)
							}),
		...
		function ModelSettingsSection(props) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", { style: css$1.divider }),
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)(ProviderListEditor, {
						api,
						t,
						ns: "looklook-audio",
		...
		function LooklookPluginCard(props) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("li", {
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
					...
					style: css.body,
					children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(LooklookFeaturesSection, { ...featuresProps }), imageRecognitionOn && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", { style: {
						border: "none",
						borderTop: "1px solid var(--dsw-alias-border-l2)"
		...
		function FileChips(props) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("style", { children: `@keyframes looklook-spin { to { transform: rotate(360deg); } }` }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					...
					children: [list.map((file, index) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
						style: {
							display: "inline-flex",
							alignItems: "center",
							gap: 6,
					...
					}, `${file.name}-${index}`)), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
						style: {
							marginLeft: "auto",
							fontSize: 12,
							lineHeight: "18px",
		...
		*/
		...
		async function uploadFile(sessionId, file, onProgress) {
			const data = await fileToBase64(file);
			return new Promise((resolveBody, rejectBody) => {
				const xhr = new XMLHttpRequest();
				xhr.open("POST", "/api/looklook-upload");
				xhr.setRequestHeader("content-type", "application/json");
				if (onProgress !== void 0) xhr.upload.onprogress = (event) => {
				...
				xhr.onload = () => {
					if (xhr.status >= 200 && xhr.status < 300) try {
						...
						if (body.ok !== true || body.path === void 0) {
						...
						rejectBody(/* @__PURE__ */ new Error("上传响应解析失败"));
					}
					else rejectBody(/* @__PURE__ */ new Error(`上传失败（HTTP ${xhr.status}）`));
				};
				xhr.onerror = () => rejectBody(/* @__PURE__ */ new Error("上传失败：网络错误"));
				xhr.onabort = () => rejectBody(/* @__PURE__ */ new Error("上传已取消"));
		...
		function apply(ctx) {
			...
			*/
			const mergeNotesIntoDraft = (sessionId, draft) => {
				const staged = pending.get(sessionId).filter((f) => f.path !== void 0 && f.path !== "" && f.uploading !== true);
				if (staged.length === 0) return draft;
				const notes = staged.map(fileNote).join("\n");
				if (pending.get(sessionId).length !== staged.length) {
					const remaining = pending.get(sessionId).filter((f) => f.path === void 0 || f.path === "" || f.uploading === true);
					const state = { ...pending.store.getSnapshot() };
					if (remaining.length > 0) state[sessionId] = remaining;
					else delete state[sessionId];
					pending.store.set(state);
				} else pending.clear(sessionId);
			...
			* the vision section in the settings card). */
			const useImageRecognition = () => useFeaturesSnapshot((s) => s.status === "ready" && s.imageRecognition !== false);
