		...
		*/
		...
		function VisionSettingsSection(props) {
			...
			(0, react.useEffect)(() => {
				(async () => {
					const response = await api.settings.describe({});
					if (response.result.ok) setProviders(visionProvidersOf(response.result.value.namespaces));
					setLoaded(true);
				})();
			}, [api]);
			...
			*/
			const renderEditor = (draft, onPatch, isNew) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				style: layout.editor,
				children: [
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("label", {
							...
							autoComplete: "off",
							value: draft.apiKey ?? "",
							placeholder: t("settings.provider.apiKeyUnset"),
						...
						children: [
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
									...
									children: [
										/* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.StateDot, { state: provider.apiKey !== void 0 && provider.apiKey.length > 0 ? "done" : "warning" }),
