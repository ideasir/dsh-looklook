...
export function isArchiveName(name) {
    return ARCHIVE_EXTENSIONS.includes(extname(name).toLowerCase());
}
 ...
 */
export function registerUploadRoutes(ctx, features) {
