...
async function describeOnce(provider, apiKey, images, maxDescribeChars, signal, question) {
...
export function statusMessage(code, model) {
    switch (code) {
 ...
 */
export async function describeImages(providers, resolveApiKey, images, maxDescribeChars, signal, question = '请详细描述这张图片的内容。') {
