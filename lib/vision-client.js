...
async function describeOnce(provider, apiKey, images, maxDescribeChars, signal) {
 ...
 */
export async function describeImages(providers, resolveApiKey, images, maxDescribeChars, signal) {
