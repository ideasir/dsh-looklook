...
import { Config, LooklookConfig, AudioConfig, looklookFeatures, eyeStateFor } from "./settings.js";
import { replaceImagesWithPlaceholder, rewriteImagesToToolReferences } from "./translate.js";
import { registerDescribeTool } from "./describe-tool.js";
import { registerZipTool } from "./zip-tool.js";
import { registerWatchTool } from "./video-tool.js";
import { registerUploadRoutes } from "./upload.js";
import { registerAsrInstallRoutes } from "./asr-install.js";
...
export { PLACEHOLDER_TEXT } from "./translate.js";
...
function admissionDecision(multimodalOn) {
...
export function apply(ctx, config) {
    ...
    const imageRecognitionEnabled = () => looklookFeatures(features).imageRecognition;
    const videoRecognitionEnabled = () => looklookFeatures(features).videoRecognition;
    ...
    ctx.on('agent/pre-step', async ({ agent, messages, signal }, next) => {
        ...
        if (eye === 'off') {
            return {
                ...decision,
                messages: replaceImagesWithPlaceholder(decision.messages),
            };
        }
